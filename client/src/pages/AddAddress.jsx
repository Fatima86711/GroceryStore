...
// 🚀 Fix 1: Move InputField outside the main component.
// This prevents it from being re-created on every render,
// which causes the input fields to lose focus.
...
const AddAddress = () => {
    const { axios, user, navigate } = useAppContent();
    ...
    useEffect(() => {
        // A more robust check to ensure the user is not just
        // in the process of being authenticated.
        if (user === null) {
            navigate('/cart');
        }
    }, [user, navigate]);

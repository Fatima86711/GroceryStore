...
const ProductCard = ({product}) => {
    ...
    const {currency,addToCart, removeFromCart, cartItems, navigate}= useAppContent();
   
//problem of image is coming and video at 1:39
    return product && (
            ...
            <div className="text-gray-500/60 text-sm">
                ...
                <div className="flex items-center gap-0.5">
                    {Array(5).fill('').map((_, i) => (
                           ...
                           <img key={i} className="md:w-3.5 w-3" src={i<4? assets.star_icon : assets.star_dull_icon}  alt="stars" />
